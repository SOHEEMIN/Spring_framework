...
<div class="container">
    ...
    <h2 class="display-4">update.jsp</h2>
    <div class="py-5 text-center">

        <form action="/update" method="post" name="updateForm">
            m_id: <input class="form-control mb-2" type="text" name="m_id" value="${updateMember.m_id}" readonly>
            memberId: <input class="form-control mb-2" type="text" name="memberId" value="${updateMember.memberId}" readonly>
            memberPassword: <input class="form-control mb-2" type="password" name=memberPassword id="pwConfirm" placeholder="비밀번호를 입력하세요.">
